function [runoff, baseflow] = routing_lohmann(inflow_direct, inflow_base, flowlen, route_par, isOutlet)
%#codegen
...
%   codegen routing_lohmann -args {coder.typeof(0,[100000 1],[1 0]),coder.typeof(0,[100000 1],[1 0]),0,zeros(1,4),0} -config cfg -report
% 
% Release Notes
